...
def add_initial_data():
    # Add initial users with plaintext passwords
    ...
    # Add initial lights
    light1 = Light(name='Elegant Chandelier', category='Chandelier', color='Gold', price=500, min_order_quantity=1, location_type='House', user_id=user2.id)
    light2 = Light(name='Modern Pendant', category='Pendant', color='Silver', price=200, min_order_quantity=5, location_type='Apartment', user_id=user2.id)
    light3 = Light(name='Classic Ceiling Light', category='Ceiling Light', color='White', price=150, min_order_quantity=10, location_type='Office', user_id=user2.id)
